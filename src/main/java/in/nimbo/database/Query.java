...
public class Query {
    public static final String INSERT_FEED = "insert into feeds(title, url) values (?, ?)";
    ...
    public static final String INSERT_REPORT = "insert into reports(feedId, title, link, pubDate, description) values (?, ?, ?, ?, ?)";
    ...
    public static final String GET_ALL_FEEDS_JDBC = "SELECT id, title, url FROM feeds";
}
